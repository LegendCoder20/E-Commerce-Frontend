...
const ProductCardsContainer = () => {
  ...
  if (isLoading)
    ...
    ); // Make a Component of Skeleton Loading and Put it inside it
              ...
              <Suspense
                ...
                fallback={
                  <div className="relative group w-full max-w-xs mx-auto mb-4 overflow-hidden">
                    ...
                    {/* Product Name */}
                    <div className="mt-2 text-center text-lg font-medium text-gray-300 bg-gray-300 rounded-md">
                      .
                    </div>

                    {/* Product Price */}
                    <div className=" text-center text-sm mt-2 text-gray-300 bg-gray-300 rounded-md">
