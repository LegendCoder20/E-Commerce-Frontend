      ...
      <nav className=" border-gray-200 bg-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          <div className="flex items-center md:order-2 ">
            ...
            <button
              type="button"
              className="flex text-sm bg-gray-800 rounded-full md:me-0 focus:ring-4 focus:ring-gray-300 focus:ring-gray-600 mr-2"
            ...
            {isDropdownOpen && (
              <div className="absolute right-0 w-48 bg-white rounded-lg shadow-lg bg-gray-700 z-20 mt-72">
                <div className="text-base list-none divide-y divide-gray-100 rounded-lg shadow bg-gray-700 divide-gray-600">
                  <ul>
                    ...
                    {user.name ? (
                      ...
                      >
                        <span className="block text-sm text-gray-900 text-white text-center">
                          User - {user.name ? user.name : "Guest"}
                        </span>
                        <span className="block text-sm text-gray-500 truncate text-gray-400 text-center">
                          {user.email}
                        </span>
                      </Link>
                    ) : (
                      <ul>
                        <Link to="/loginUser">
                          <span className="block text-gray-900 text-white text-center  px-4 py-3 text-sm list-none divide-y divide-gray-100 rounded-lg shadow bg-gray-700 divide-gray-600   hover:bg-gray-100 hover:bg-gray-600  hover:text-white">
                            Login as A User
                          </span>
                        </Link>
                      </ul>
                  ...
                  <ul className="py-2">
                    ...
                    {user.name && (
                      <li>
                        <Link
                          to="/usercart"
                          className="block text-gray-900 text-white text-center px-4 py-3 text-sm list-none divide-y divide-gray-100 rounded-lg shadow bg-gray-700 divide-gray-600 hover:bg-gray-100 hover:bg-gray-600 hover:text-white"
                        >
          ...
          <button
            ...
            type="button"
            className="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 text-white hover:bg-gray-700 focus:ring-gray-600"
            onClick={toggleMenu}
          >
          ...
          <div
            ...
            id="navbar-user"
          >
            <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0   bg-gray-800 md:bg-gray-900 border-gray-700">
              <li>
                <Link
                  to="/"
                  className="relative block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:text-teal-300 md:text-lg md:hover:text-teal-500 after:content-[''] after:block after:h-1 after:bg-teal-400  after:absolute after:bottom-0 after:left-0 after:w-full after:scale-x-0 after:origin-left after:transition-transform after:duration-300 hover:after:scale-x-100"
                  aria-current="page"
                >
                  Home
                </Link>
